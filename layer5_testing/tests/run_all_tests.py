"""
AEGIS 3.0 Layer 5 - Master Test Runner
"""
...
def run_all_tests():
    print("=" * 70)
    print("    AEGIS 3.0 LAYER 5 TEST SUITE")
    print("    Simplex Safety Supervisor Validation")
    print("=" * 70)
    ...
    # Run all L5 tests
    print("\n" + "-" * 70)
    print("Running Tests L5-1 to L5-7: Safety Supervisor Tests")
    print("-" * 70)
    try:
        from test_L5_safety import run_test
        results = run_test()
    ...
    print("\n" + "=" * 70)
    print("    LAYER 5 TEST SUITE SUMMARY")
    print("=" * 70)
    print(f"\n  Total Tests:  {total}")
    ...
    output_path = os.path.join(RESULTS_DIR, 'layer5_all_results.json')
